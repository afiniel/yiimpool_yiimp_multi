...
script_create_user=${dir}'/yiimpool/yiimp_multi/create_user_remote.sh'
script_system_web=${dir}'/yiimpool/yiimp_multi/remote_system_web_server.sh'
script_self_ssl=${dir}'/yiimpool/yiimp_multi/self_ssl.sh'
script_web_web=${dir}'/yiimpool/yiimp_multi/remote_web_web_server.sh'
script_nginx_web=${dir}'/yiimpool/yiimp_multi/nginx_upgrade.sh'
script_clean_web=${dir}'/yiimpool/yiimp_multi/server_cleanup.sh'
script_sendmail_web=${dir}'/yiimpool/yiimp_multi/send_mail.sh'
script_motd_web=${dir}'/yiimpool/yiimp_multi/motd.sh'
script_harden_web=${dir}'/yiimpool/yiimp_multi/server_harden.sh'
script_ssh=${dir}'/yiimpool/yiimp_multi/ssh.sh'

# Additional files that need to be copied to the remote server
functioncopy=${dir}'/yiimpool/yiimp_multi/required_remote_files/functions.sh'
conf=${STORAGE_ROOT}'/yiimp/.yiimp.conf'
screens=${dir}'/yiimpool/yiimp_multi/ubuntu/screens'
header=${dir}'/yiimpool/yiimp_multi/ubuntu/etc/update-motd.d/00-header'
sysinfo=${dir}'/yiimpool/yiimp_multi/ubuntu/etc/update-motd.d/10-sysinfo'
footer=${dir}'/yiimpool/yiimp_multi/ubuntu/etc/update-motd.d/90-footer'
first_boot=${dir}'/yiimpool/yiimp_multi/first_boot.sh'
nginx_conf=${dir}'/yiimpool/yiimp_multi/nginx_confs/nginx.conf'
nginx_general=${dir}'/yiimpool/yiimp_multi/nginx_confs/general.conf'
nginx_letsencrypt=${dir}'/yiimpool/yiimp_multi/nginx_confs/letsencrypt.conf'
nginx_php=${dir}'/yiimpool/yiimp_multi/nginx_confs/php_fastcgi.conf'
nginx_security=${dir}'/yiimpool/yiimp_multi/nginx_confs/security.conf'
nginx_domain_nonssl=${dir}'/yiimpool/yiimp_multi/nginx_domain_nonssl.sh'
nginx_domain_ssl=${dir}'/yiimpool/yiimp_multi/nginx_domain_ssl.sh'
nginx_subdomain_nonssl=${dir}'/yiimpool/yiimp_multi/nginx_subdomain_nonssl.sh'
nginx_subdomain_ssl=${dir}'/yiimpool/yiimp_multi/nginx_subdomain_ssl.sh'
yiimp_conf=${dir}'/yiimpool/yiimp_multi/yiimp_confs/yiimpserverconfig.sh'
yiimp_blocks=${dir}'/yiimpool/yiimp_multi/yiimp_confs/blocks.sh'
yiimp_keys=${dir}'/yiimpool/yiimp_multi/yiimp_confs/keys.sh'
yiimp_loop2=${dir}'/yiimpool/yiimp_multi/yiimp_confs/loop2.sh'
yiimp_main=${dir}'/yiimpool/yiimp_multi/yiimp_confs/main.sh'
