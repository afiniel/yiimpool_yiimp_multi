...
script_daemon=${dir}'/yiimpool/yiimp_multi/remote_daemon.sh'
...
header=${dir}'/yiimpool/yiimp_multi/ubuntu/etc/update-motd.d/daemon/00-header'
sysinfo=${dir}'/yiimpool/yiimp_multi/ubuntu/etc/update-motd.d/daemon/10-sysinfo'
footer=${dir}'/yiimpool/yiimp_multi/ubuntu/etc/update-motd.d/daemon/90-footer'
