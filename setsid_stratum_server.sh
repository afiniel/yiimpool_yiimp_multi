...
script_system_stratum=${dir}'/yiimpool/yiimp_multi/remote_system_stratum_server.sh'
script_stratum=${dir}'/yiimpool/yiimp_multi/remote_stratum.sh'
...
screens=${dir}'/yiimpool/yiimp_multi/ubuntu/screens_stratum'
addport=${dir}'/yiimpool/yiimp_multi/ubuntu/addport'
addport_multi=${dir}'/yiimpool/yiimp_multi/ubuntu/addport_multi_stratums'
header=${dir}'/yiimpool/yiimp_multi/ubuntu/etc/update-motd.d/stratum/00-header'
sysinfo=${dir}'/yiimpool/yiimp_multi/ubuntu/etc/update-motd.d/stratum/10-sysinfo'
footer=${dir}'/yiimpool/yiimp_multi/ubuntu/etc/update-motd.d/stratum/90-footer'
