...
sudo cp -r /tmp/general.conf /etc/nginx/afiniel
sudo cp -r /tmp/php_fastcgi.conf /etc/nginx/afiniel
sudo cp -r /tmp/security.conf /etc/nginx/afiniel
sudo cp -r /tmp/letsencrypt.conf /etc/nginx/afiniel
